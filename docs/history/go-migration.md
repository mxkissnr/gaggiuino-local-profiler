# Go migration history

Archived from `gaggiuino-local-profiler/go/README.md` (#1177). It records the
Node → Go migration (#901, cutover #977, Node removed in 3.0.0 / #1028) and is
not maintained. Paths in code spans are relative to `gaggiuino-local-profiler/go/`.

The current backend documentation is in
[`gaggiuino-local-profiler/go/README.md`](../../gaggiuino-local-profiler/go/README.md).
...
## Frontend migration notes (formerly in go/README.md's "Frontend")
