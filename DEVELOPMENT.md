...
|---|---|---|---|---|
| gaggiuino-local-profiler | 2026-05-20 | 2026-07-24 | 642 | 498 (78%) |
...
| **Combined** | **2026-05-20** | **2026-07-24** | **853** | **673 (79%)** |

![Commits per repo](docs/dev-stats/commits-per-repo.png)

Combined line changes (insertions + deletions across all commits): **266.089**, of which **202.719** landed in Claude-co-authored commits.
...
**Estimated cost: ~$30.83** across 199.450 priced lines (+ 3.269 lines from unpriced models, excluded from this total).
