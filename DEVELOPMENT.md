...
|---|---|---|---|---|
| gaggiuino-local-profiler | 2026-05-20 | 2026-07-25 | 645 | 499 (77%) |
...
| **Combined** | **2026-05-20** | **2026-07-25** | **856** | **674 (79%)** |

![Commits per repo](docs/dev-stats/commits-per-repo.png)

Combined line changes (insertions + deletions across all commits): **266.524**, of which **203.069** landed in Claude-co-authored commits.
...
**Estimated cost: ~$30.86** across 199.801 priced lines (+ 3.268 lines from unpriced models, excluded from this total).
