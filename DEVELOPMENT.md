...
|---|---|---|---|---|
| gaggiuino-local-profiler | 2026-05-20 | 2026-07-26 | 650 | 501 (77%) |
...
| **Combined** | **2026-05-20** | **2026-07-26** | **863** | **676 (78%)** |

![Commits per repo](docs/dev-stats/commits-per-repo.png)

Combined line changes (insertions + deletions across all commits): **267.305**, of which **203.215** landed in Claude-co-authored commits.
