...
Generated 2026-07-25 by `scripts/dev-stats.mjs`. Re-run it any time to refresh these numbers — they are computed live from git history, not hand-maintained.

## Timeline

The GLP ecosystem (this app + 3 companion repos) has been in development since **2026-05-20** — **67 days** as of the last commit (2026-07-25).

| Repo | First commit | Last commit | Commits | Claude co-authored |
|---|---|---|---|---|
| gaggiuino-local-profiler | 2026-05-20 | 2026-07-25 | 648 | 501 (77%) |
...
| **Combined** | **2026-05-20** | **2026-07-25** | **861** | **676 (79%)** |

![Commits per repo](docs/dev-stats/commits-per-repo.png)

Combined line changes (insertions + deletions across all commits): **266.838**, of which **203.215** landed in Claude-co-authored commits.
...
**Estimated cost: ~$30.85** across 199.956 priced lines (+ 3.258 lines from unpriced models, excluded from this total).
