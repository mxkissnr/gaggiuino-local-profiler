...
The GLP ecosystem (this app + 3 companion repos) has been in development since **2026-05-20** — **52 days** as of the last commit (2026-07-10).

| Repo | First commit | Last commit | Commits | Claude co-authored |
|---|---|---|---|---|
| gaggiuino-local-profiler | 2026-05-20 | 2026-07-10 | 422 | 328 (78%) |
...
| **Combined** | **2026-05-20** | **2026-07-10** | **602** | **480 (80%)** |

![Commits per repo](docs/dev-stats/commits-per-repo.png)

Combined line changes (insertions + deletions across all commits): **222.526**, of which **167.587** landed in Claude-co-authored commits.
...
**Estimated cost: ~$28.65** across 165.525 priced lines (+ 2.062 lines from unpriced models, excluded from this total).
