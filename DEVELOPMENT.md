...
|---|---|---|---|---|
| gaggiuino-local-profiler | 2026-05-20 | 2026-07-22 | 589 | 466 (79%) |
...
| **Combined** | **2026-05-20** | **2026-07-22** | **799** | **640 (80%)** |

![Commits per repo](docs/dev-stats/commits-per-repo.png)

Combined line changes (insertions + deletions across all commits): **259.513**, of which **198.184** landed in Claude-co-authored commits.
...
**Estimated cost: ~$30.78** across 194.784 priced lines (+ 3.400 lines from unpriced models, excluded from this total).
