...
|---|---|---|---|---|
| gaggiuino-local-profiler | 2026-05-20 | 2026-07-21 | 542 | 423 (78%) |
...
| **Combined** | **2026-05-20** | **2026-07-21** | **752** | **597 (79%)** |

![Commits per repo](docs/dev-stats/commits-per-repo.png)

Combined line changes (insertions + deletions across all commits): **248.182**, of which **190.931** landed in Claude-co-authored commits.
...
**Estimated cost: ~$29.62** across 187.347 priced lines (+ 3.584 lines from unpriced models, excluded from this total).
