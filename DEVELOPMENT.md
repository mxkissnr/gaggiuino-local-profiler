...
|---|---|---|---|---|
| gaggiuino-local-profiler | 2026-05-20 | 2026-07-24 | 639 | 497 (78%) |
...
| **Combined** | **2026-05-20** | **2026-07-24** | **850** | **672 (79%)** |

![Commits per repo](docs/dev-stats/commits-per-repo.png)

Combined line changes (insertions + deletions across all commits): **265.559**, of which **202.515** landed in Claude-co-authored commits.
...
**Estimated cost: ~$30.82** across 199.244 priced lines (+ 3.271 lines from unpriced models, excluded from this total).
