...
|---|---|---|---|---|
| gaggiuino-local-profiler | 2026-05-20 | 2026-07-23 | 618 | 486 (79%) |
...
| **Combined** | **2026-05-20** | **2026-07-23** | **829** | **661 (80%)** |

![Commits per repo](docs/dev-stats/commits-per-repo.png)

Combined line changes (insertions + deletions across all commits): **264.361**, of which **201.867** landed in Claude-co-authored commits.
...
**Estimated cost: ~$30.93** across 198.539 priced lines (+ 3.329 lines from unpriced models, excluded from this total).
