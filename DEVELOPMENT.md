...
|---|---|---|---|---|
| gaggiuino-local-profiler | 2026-05-20 | 2026-07-06 | 368 | 310 (84%) |
...
| **Combined** | **2026-05-20** | **2026-07-06** | **528** | **456 (86%)** |

![Commits per repo](docs/dev-stats/commits-per-repo.png)

Combined line changes (insertions + deletions across all commits): **169.816**, of which **164.006** landed in Claude-co-authored commits.
