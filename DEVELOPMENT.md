...
|---|---|---|---|---|
| gaggiuino-local-profiler | 2026-05-20 | 2026-07-24 | 633 | 493 (78%) |
...
| **Combined** | **2026-05-20** | **2026-07-24** | **844** | **668 (79%)** |

![Commits per repo](docs/dev-stats/commits-per-repo.png)

Combined line changes (insertions + deletions across all commits): **265.143**, of which **202.320** landed in Claude-co-authored commits.
...
**Estimated cost: ~$30.86** across 199.027 priced lines (+ 3.293 lines from unpriced models, excluded from this total).
