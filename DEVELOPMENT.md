...
|---|---|---|---|---|
| gaggiuino-local-profiler | 2026-05-20 | 2026-07-20 | 539 | 423 (78%) |
...
| **Combined** | **2026-05-20** | **2026-07-20** | **749** | **597 (80%)** |

![Commits per repo](docs/dev-stats/commits-per-repo.png)

Combined line changes (insertions + deletions across all commits): **241.551**, of which **184.339** landed in Claude-co-authored commits.
...
**Estimated cost: ~$28.62** across 180.880 priced lines (+ 3.459 lines from unpriced models, excluded from this total).
