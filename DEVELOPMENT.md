...
|---|---|---|---|---|
| gaggiuino-local-profiler | 2026-05-20 | 2026-07-24 | 630 | 491 (78%) |
...
| **Combined** | **2026-05-20** | **2026-07-24** | **841** | **666 (79%)** |

![Commits per repo](docs/dev-stats/commits-per-repo.png)

Combined line changes (insertions + deletions across all commits): **264.935**, of which **202.226** landed in Claude-co-authored commits.
...
**Estimated cost: ~$30.89** across 198.923 priced lines (+ 3.304 lines from unpriced models, excluded from this total).
