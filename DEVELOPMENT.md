...
|---|---|---|---|---|
| gaggiuino-local-profiler | 2026-05-20 | 2026-07-24 | 636 | 495 (78%) |
...
| **Combined** | **2026-05-20** | **2026-07-24** | **847** | **670 (79%)** |

![Commits per repo](docs/dev-stats/commits-per-repo.png)

Combined line changes (insertions + deletions across all commits): **265.317**, of which **202.455** landed in Claude-co-authored commits.
...
**Estimated cost: ~$30.85** across 199.173 priced lines (+ 3.283 lines from unpriced models, excluded from this total).
