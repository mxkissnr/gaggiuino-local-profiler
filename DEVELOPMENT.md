...
|---|---|---|---|---|
| gaggiuino-local-profiler | 2026-05-20 | 2026-07-21 | 579 | 458 (79%) |
...
| **Combined** | **2026-05-20** | **2026-07-21** | **789** | **632 (80%)** |

![Commits per repo](docs/dev-stats/commits-per-repo.png)

Combined line changes (insertions + deletions across all commits): **253.631**, of which **192.646** landed in Claude-co-authored commits.
...
**Estimated cost: ~$29.63** across 189.287 priced lines (+ 3.359 lines from unpriced models, excluded from this total).
