...
|---|---|---|---|---|
| gaggiuino-local-profiler | 2026-05-20 | 2026-07-12 | 450 | 355 (79%) |
...
| **Combined** | **2026-05-20** | **2026-07-12** | **638** | **514 (81%)** |

![Commits per repo](docs/dev-stats/commits-per-repo.png)

Combined line changes (insertions + deletions across all commits): **227.238**, of which **172.299** landed in Claude-co-authored commits.
...
**Estimated cost: ~$28.38** across 168.468 priced lines (+ 3.830 lines from unpriced models, excluded from this total).
