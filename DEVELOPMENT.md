...
Generated 2026-07-20 by `scripts/dev-stats.mjs`. Re-run it any time to refresh these numbers — they are computed live from git history, not hand-maintained.

## Timeline

The GLP ecosystem (this app + 3 companion repos) has been in development since **2026-05-20** — **62 days** as of the last commit (2026-07-20).

| Repo | First commit | Last commit | Commits | Claude co-authored |
|---|---|---|---|---|
| gaggiuino-local-profiler | 2026-05-20 | 2026-07-20 | 534 | 418 (78%) |
...
| **Combined** | **2026-05-20** | **2026-07-20** | **744** | **592 (80%)** |

![Commits per repo](docs/dev-stats/commits-per-repo.png)

Combined line changes (insertions + deletions across all commits): **239.792**, of which **182.580** landed in Claude-co-authored commits.
...
**Estimated cost: ~$28.45** across 179.116 priced lines (+ 3.464 lines from unpriced models, excluded from this total).
