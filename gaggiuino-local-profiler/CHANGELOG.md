...
- **Library photos now show in screenshots taken from a restored backup even when the first fetch of a photo fails, and the Orders/Live screenshots now keep the seeded demo data instead of being overwritten by a backup's empty views.** Closes #1185
