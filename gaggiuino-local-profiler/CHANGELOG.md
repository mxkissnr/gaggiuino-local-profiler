...
- **The firmware-update entity no longer silently gets stuck reporting no update for a full hour when the latest-release lookup finds no match**, which is now logged and retried much sooner instead of being cached as a good result for the full hour. Closes #1042
