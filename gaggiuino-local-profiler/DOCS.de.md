...
Auf schmalen Bildschirmen (Smartphones, Tablets im Hochformat) ersetzt eine **Bottom-Navigation** die horizontale Tab-Leiste: Shots / Live / Bibliothek / Statistiken plus ein „Mehr"-Sheet mit Bezugslog / Wartung / Einstellungen / Bestellungen. Ein Tap auf „Shots" öffnet die Shot-Liste als eigenen Screen statt als dauerhaft angedockte Sidebar-Spalte, sodass Verdict-Header, Rezept-Zone und der volle Chart auf einem typischen Smartphone-Bildschirm ohne Scrollen sichtbar sind. Die obere Mode-Leiste bleibt nur noch für den Multi-Maschinen-Umschalter erhalten und blendet sich selbst aus, wenn dort nichts anzuzeigen ist. Bedienelemente, die am Desktop erst bei Hover erscheinen (z. B. der Vergleichen-Button in der Shotliste, die Sternebewertung), bekommen auf Touch-Geräten ein volles 44×44px-Tapziel. Zwei Dinge sind noch nicht in die mobile Ansicht übernommen: Badge-Zähler (Wartung/Bestellungen) erscheinen nicht im „Mehr"-Sheet, nur die Sichtbarkeit der Einträge ist genauso gesteuert wie am Desktop; und die pulsierende „Shot läuft"-Anzeige des Live-Tabs wird nicht auf das Bottom-Nav-Icon übertragen, das nur ein-/ausgeblendet wird.
