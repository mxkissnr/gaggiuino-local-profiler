...
Auf schmalen Bildschirmen (Smartphones, Tablets im Hochformat) wird die Tab-Leiste ausgeblendet, stattdessen übernimmt eine **Bottom-Navigation**: Shots / Live / Bibliothek / Statistiken plus ein „Mehr"-Sheet mit Bezugslog / Wartung / Einstellungen / Bestellungen — jeder Eintrag hat ein Icon, keine Emoji mehr in der Navigation. Die Shot-Liste ist der primäre „Shots"-Screen, kein Drawer/Overlay: ein Tap auf einen Shot wechselt zur Detailansicht, ein Zurück-Pfeil in der Kopfzeile führt zur Liste zurück. Ein neuer **Burger-Button** klappt die Shot-Liste zusätzlich als Overlay-Drawer mit Backdrop aus — schließbar per Swipe-nach-links oder Tap auf den Backdrop, erreichbar aus jeder Ansicht neben der Bottom-Navigation, sodass man auch aus Live, Bibliothek oder Statistiken direkt zur Shot-Liste zurückspringen kann. Bedienelemente, die am Desktop erst bei Hover erscheinen (z. B. der Vergleichen-Button in der Shotliste, die Sternebewertung), bekommen auf Touch-Geräten ein volles 44×44px-Tapziel. Zwei Dinge sind noch nicht in die mobile Ansicht übernommen: Badge-Zähler (Wartung/Bestellungen) erscheinen nicht im „Mehr"-Sheet, nur die Sichtbarkeit der Einträge ist genauso gesteuert wie am Desktop; und die pulsierende „Shot läuft"-Anzeige des Live-Tabs wird nicht auf das Bottom-Nav-Icon übertragen, das nur ein-/ausgeblendet wird.
