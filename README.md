...
|---|---|---|
| **GLP App** | v1.82.7 | — |
| **GLP Integration** ([glp-integration](https://github.com/mxkissnr/glp-integration)) | v1.11.0 | App v1.82.7+ |
| **GLP Lovelace Card** ([glp-lovelace-card](https://github.com/mxkissnr/glp-lovelace-card)) | v2.7.1 | Integration v1.9.0+ |
