...
| 📲 | **Installable App (PWA)** | Add to your phone's home screen for a standalone app (own icon, no browser bar) — works over the add-on's directly-exposed port, no Home Assistant dashboard needed to open it |
